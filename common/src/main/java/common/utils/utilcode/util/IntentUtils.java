...
public final class IntentUtils {
    ...
    public static <T extends Activity> void startActivity(Activity activity, Class<T> clazz) {
    ...
    public static <T extends Activity> Intent getIntent(Context context, Class<T> clazz, boolean newTask) {
    ...
    public static void openApp(Context context, String pkg) {
        Intent launchAppIntent = getLaunchAppIntent(pkg);
        startActivity(context, launchAppIntent);
    }

    public static <T extends Service> void startService(Context ctx, Class<T> clazz) {
        Intent intent = new Intent(ctx, clazz);
        startActivity(ctx, intent);
    }

    public static <T extends Activity> void startActivity(Context ctx, Class<T> clazz) {
        startActivity(ctx, new Intent(ctx, clazz));
    }

    public static <T extends Activity> void startActivityFinishSelf(Activity ctx, Class<T> clazz) {
        startActivity(ctx, new Intent(ctx, clazz));
        ctx.finish();
    }

    public static <T extends Activity> void startActivityWithNewTask(Context ctx, Class<T> clazz) {
        Intent intent = new Intent(ctx, clazz);
        startActivity(ctx, intent);
    }


    public static void startActivityWithNewTask(Context ctx, Intent intent) {
        intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        ctx.startActivity(intent);
    }

    public static void startActivityFinishSelf(Activity ctx, Intent intent) {
        startActivity(ctx, intent);
        ctx.finish();
    }
