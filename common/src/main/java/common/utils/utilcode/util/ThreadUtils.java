...
public final class ThreadUtils {
    ...
    public static void uiExcude(Runnable runnable, long delay) {
        getUiThreadHandler().postDelayed(runnable, delay);
    }

    public static void asycExcude(Runnable runnable) {
        new Thread(runnable).start();
    }

    public static void asycExcude(Runnable runnable, long delay) {
        try {
            Thread.sleep(delay);
        } catch (Exception e) {
            e.printStackTrace();
